...
const NavBar = () => {
  ...
  return (
    <nav className="flex justify-between items-center py-6 md:px-12 px-4 bg-none text-white">
      ...
      <Link href="/" className="hover:text-red-500 transition duration-300">Главная</Link>
      ...
      <div className="hidden md:flex flex-1 justify-end gap-6 text-red-500 text-xl">
        ...
        <Link href="https://www.instagram.com/spectr.marketing/" className="hover:text-white text-2xl transition duration-300"><FaInstagram /></Link>
        <Link href="tel:+998999444744" className="hover:text-white text-2xl transition duration-300"><FaPhone /></Link>
      ...
      {menuOpen && (
        <div className="absolute z-50 top-0 left-0 w-full h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-xl">
          ...
          <div className="flex gap-6 text-red-500 text-2xl">
            ...
            <Link href="https://www.instagram.com/spectr.marketing/" className="hover:text-white transition duration-300" onClick={() => setMenuOpen(false)}><FaInstagram /></Link>
            <Link href="tel:+998999444744" className="hover:text-white transition duration-300" onClick={() => setMenuOpen(false)}><FaPhone /></Link>
